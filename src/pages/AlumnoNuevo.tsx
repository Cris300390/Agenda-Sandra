...
export default function Alumnos() {
  ...
  // 2) Lista filtrada (buscador + filtro activos)
  ...
  // 4) Eliminar alumno (y sus datos relacionados)
      ...
      <div className="modal-content">
        ...
        <div className="modal-actions">
          ...
          <button
            ...
            onClick={() => onSave({ id: student?.id, name, color, notes, nextClassNotes, active: true, age, grade, subjects, repeated })}
            disabled={!name.trim()}
          >
            Guardar
          </button>
